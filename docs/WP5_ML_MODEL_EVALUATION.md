...
1. **Champion Candidate Performance:** The current in-memory production candidate `xgb-v3.0-real-candidate` achieves **69.89% Accuracy**, **74.01% Balanced Accuracy**, **0.6444 Macro F1**, and **97.26% Tier 1 Selective Accuracy** (with a 2.74% error rate on 41.5% operational coverage).
