        ...
        **kwargs
        ...
        # PHASE 11.1 ACCEPTANCE: VERIFY EVIDENCE GRAPH & EXPLAIN METRICS DISAMBIGUATION
            ...
            summary_text = (
                ...
                f"   - **Definition:** Statistical posterior class probability estimated by machine learning (the candidate model estimated this; human verification remains pending).\n"
                f"   - **Governed Inference Model:** `xgb-v3.0-real-candidate` (Status: CANDIDATE | Artifact SHA-256: `c52b6369...` | Human Verification Pending).\n"
                f"   - **Calibration:** Balanced Platt Calibrator (`balanced-platt-v3.0`) mapped across target classes.\n"
                f"   - **Note:** Classifier probability measures tabular feature likelihood, NOT physical hazard confirmation or operational urgency.\n\n"
