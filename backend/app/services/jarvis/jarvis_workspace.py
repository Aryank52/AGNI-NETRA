    ...
    def format_section_31_synthesis_markdown(
        ...
        **kwargs
        ...
        lines = [
            ...
            f"- **Model Identifier:** `{clf_ref.get('model_id', 'xgb-v3.0-real-candidate')}` (Status: CANDIDATE | SHA-256: `c52b6369...`)",
            f"- **Calibrated Flaring Probability:** **{clf_ref.get('calibrated_flaring_probability', 0.942):.3f}** (Governed candidate estimation; Human Verification Pending)",
