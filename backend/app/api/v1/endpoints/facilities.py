...
from backend.app.models.domain import IndustrialFacility, HistoricalBaseline, ThermalEvent
from backend.app.models.schemas import IndustrialFacilityOut, ThermalEventOut
from backend.app.services.baseline_service import generate_thermal_fingerprint
...
def get_industrial_facilities(
    ...
    """
    query = db.query(IndustrialFacility).options(joinedload(IndustrialFacility.baselines))
