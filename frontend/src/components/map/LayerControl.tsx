...
const LAYER_ITEMS: LayerItemDef[] = [
  ...
  // 3. ENERGY
  {
    key: "powerStations",
    category: "ENERGY",
    label: "Power Cadastre & CEA Stations",
    sublabel: "4,125 Plants · 1,633 CEA Units (502 Stations)",
    icon: Zap,
    color: "#f59e0b",
    countDefault: 4125,
    countKey: "power_stations",
    provenance: "Central Electricity Authority + OSM",
  },
  // 4. MINING
  {
    key: "mining",
    category: "MINING",
    label: "Mining Sites & IBM Leases",
    sublabel: "206 Active Sites · 414 Extraction Leases",
    icon: Pickaxe,
    color: "#a855f7",
    countDefault: 206,
    countKey: "mining",
    provenance: "Indian Bureau of Mines + OSM",
  },
  // 5. ENVIRONMENT
  {
    key: "protectedAreas",
  ...
  // 7. ADMINISTRATIVE
  {
    ...
    provenance: "Survey of India (geoBoundaries ADM1)",
  },
  {
    key: "districtBoundaries",
    category: "ADMINISTRATIVE",
    label: "District Boundaries",
    sublabel: "735 District Administrative Borders",
    icon: Layers,
    color: "#64748b",
    countDefault: 735,
    countKey: "admin_districts",
    provenance: "Survey of India (geoBoundaries ADM2)",
  },
  // 8. REGULATORY
  {
    key: "parivesh",
