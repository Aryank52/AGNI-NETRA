      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6 space-y-6 max-w-7xl mx-auto">
          ...
          <PageHeader
            ...
            title="Dataset Control Center & Label Provenance"
            titleIcon={<Database className="w-6 h-6 text-purple-400" />}
            description="Manage partitioned training datasets with strict isolation across REAL, HUMAN_VERIFIED, and SYNTHETIC data."
            breadcrumbs={[
          ...
          {/* Dataset Cards Grid or Loading / Empty States */}
          {loading ? (
            ...
            <EmptyState
              ...
              description="No partitioned datasets have been registered in the governance manifest."
              icon={Database}
