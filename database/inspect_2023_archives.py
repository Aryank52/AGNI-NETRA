"""
AGNI-NETRA — Detailed Inspection & Completeness Audit for NASA FIRMS 2023 Archives
"""
...
TARGET_DIR = r"E:\PROJECTS\AGNI-NETRA(DATABASE)\FIRMS\HISTORICAL\2023\full"

zips = [
    "DL_FIRE_J1V-C2_795858.zip",
    "DL_FIRE_SV-C2_795859.zip",
    "DL_FIRE_M-C61_795857.zip"
]
...
print("=" * 85)
print("  AGNI-NETRA — PHASE 5C: NASA FIRMS 2023 ARCHIVE PRE-INGESTION AUDIT")
print("=" * 85)
...
print("\n" + "=" * 85)
print("  OVERALL 2023 ARCHIVE COMPLETENESS AUDIT")
print("=" * 85)
print(f"Total Source Rows Across Archives: {overall_stats['total_source_rows']:,}")
print(f"Total Distinct Acquisition Days  : {len(overall_stats['distinct_dates'])} / 365 days")
...
full_year_covered = min(overall_stats["distinct_dates"]) == "2023-01-01" and max(overall_stats["distinct_dates"]) == "2023-12-31"

if all_months_present and full_year_covered:
    completeness_status = "FULL_ARCHIVE"
else:
